...
import type { ChargeTransaction, DeviceRegistry, StationRegistry } from "../../typechain-types/index.js";
...
describe("ChargeTransaction", function () {
  ...
  beforeEach(async function () {
    ...
    const { contract: ctContract, proxy } = await deployUUPSProxy<ChargeTransaction>(ethers, "ChargeTransaction");
